...
get_orientation(Orientation) :-
  ...
  nl,
  write('1- '),put_code(9633),write(' '),put_code(9632), write(' 2- '),put_code(9632),write(' '),put_code(9633), nl,
  write('   '),put_code(9633),write(' '),put_code(9632), write('    '),put_code(9632),write(' '),put_code(9633), nl,
  nl,
  write('3- '),put_code(9633),write(' '),put_code(9633), write(' 2- '),put_code(9632),write(' '),put_code(9632), nl,
  write('   '),put_code(9632),write(' '),put_code(9632), write('    '),put_code(9633),write(' '),put_code(9633), nl,
  nl, 
  write('Orientation:'),
...
% validate_valid_move(+Move, +ValidModes)
% checks wether a valid move is indeed valid
validate_valid_move(X-Y-Orientation,ValidMoves) :-
